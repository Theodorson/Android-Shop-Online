...
public class DatabaseBook {
    ...
    public void populateDatabase(){
        ...
        Book book1 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/6126/9781612620244.jpg", 200, 45, 55
                );
        Book book2 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9788/4679/9788467941920.jpg", 192, 35,25
        );
        Book book3 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/5101/9781510106284.jpg", 512, 0, 50
        );
        Book book4 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/5343/9781534313408.jpg", 1096, 10,100
        );
        Book book5 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/6126/9781612629216.jpg", 192, 25,30
        );
        Book book6 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/6126/9781612620732.jpg", 282, 40,35
        );
        Book book7 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/9052/9781905239603.jpg", 196, 20,50
        );
        Book book8 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4215/9781421580364.jpg", 224, 30,30
        );
        Book book9 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4215/9781421585116.jpg", 192, 29,32
        );
        Book book10 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4215/9781421585642.jpg", 200, 60,28
        );
        Book book11 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/5067/9781506711980.jpg", 696, 70,75
        );
        Book book12 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/5693/9781569319000.jpg", 192, 100,25
        );
        Book book13 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4215/9781421599489.jpg", 208, 95,45
        );
        Book book14 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4215/9781421540184.jpg", 576, 65,80
        );
        Book book15 = new Book(
                ...
                "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4215/9781421517964.jpg", 200, 55,35
        );
        //set id-s
        book1.setId(1);
        book2.setId(2);
        ...
        databaseRef.child("3").setValue(book3);
        databaseRef.child("4").setValue(book4);
        databaseRef.child("5").setValue(book5);
        databaseRef.child("6").setValue(book6);
        databaseRef.child("7").setValue(book7);
        databaseRef.child("8").setValue(book8);
        databaseRef.child("9").setValue(book9);
        databaseRef.child("10").setValue(book10);
        databaseRef.child("11").setValue(book11);
        databaseRef.child("12").setValue(book12);
        databaseRef.child("13").setValue(book13);
        databaseRef.child("14").setValue(book14);
        databaseRef.child("15").setValue(book15);
    }
